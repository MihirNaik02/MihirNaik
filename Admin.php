      ...
      <ul class="nav-links">
        ...
        <li class="log_out">
          <a href="#">
            ...
            <span onclick="logout()" id="logout" class="links_name">Log out</span>
          </a>
        </li>
      </ul>
  </div>
  <section class="home-section">
    <nav>
      ...
      <div class="profile-details">
        ...
        <span class="admin_name">Mihir Naik</span>
    ...
    <div class="home-content">
      ...
      <div class="sales-boxes">
        <div class="recent-sales box">
          ...
          <ul class="details">
            <li class="topic">Doctor Assigned</li>
